...
### 출력 
 ...
 <p>커피 추첨 대상자가 아니라면 <span style="color: rgb(231, 76, 60); --darkreader-inline-color: var(--darkreader-text-e74c3c, #e95849);" data-darkreader-inline-color=""><code>none</code></span>을 출력하고, 해커라면 <span style="color: rgb(231, 76, 60); --darkreader-inline-color: var(--darkreader-text-e74c3c, #e95849);" data-darkreader-inline-color=""><code>hacker</code></span>를 출력한다. 그 외의 경우에는 <span style="color: rgb(231, 76, 60); --darkreader-inline-color: var(--darkreader-text-e74c3c, #e95849);" data-darkreader-inline-color=""><code>draw</code></span>를 출력한다.</p>
