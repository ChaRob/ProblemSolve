...
### 출력 
 ...
 <p>코이가 라면을 성공적으로 끓여 먹을 수 있다면 <span style="color: rgb(231, 76, 60); --darkreader-inline-color: var(--darkreader-text-e74c3c, #e95849);" data-darkreader-inline-color=""><code>yaho</code></span>를, 그렇지 않다면 <span style="color: rgb(231, 76, 60); --darkreader-inline-color: var(--darkreader-text-e74c3c, #e95849);" data-darkreader-inline-color=""><code>no</code></span>를 출력한다.</p>
