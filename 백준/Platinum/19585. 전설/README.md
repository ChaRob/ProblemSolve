...
### 출력 
 ...
 <p>팀명이 입력된 순서대로, 전설에 따라 해당 팀이 다음 리저널에서 수상할 수 있다면 <tt><span style="background-color: rgb(221, 221, 221); --darkreader-inline-bgcolor: var(--darkreader-background-dddddd, #2b2f31);" data-darkreader-inline-bgcolor="">Yes</span></tt>, 아니라면 <tt><span style="background-color: rgb(221, 221, 221); --darkreader-inline-bgcolor: var(--darkreader-background-dddddd, #2b2f31);" data-darkreader-inline-bgcolor="">No</span></tt>를 출력한다.</p>
