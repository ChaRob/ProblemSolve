...
### 출력 
 ...
 <p>두 문자열이 조건을 만족한다면 <span style="color: rgb(231, 76, 60); --darkreader-inline-color: var(--darkreader-text-e74c3c, #e95849);" data-darkreader-inline-color=""><code>YES</code></span>, 만족하지 않는다면 <span style="color: rgb(231, 76, 60); --darkreader-inline-color: var(--darkreader-text-e74c3c, #e95849);" data-darkreader-inline-color=""><code>NO</code></span>를 출력한다.</p>
